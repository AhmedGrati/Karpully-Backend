...
export class Location {
  ...
  checkInformationRelativityToTunisia() {
    ...
    if (lat < xy_limits.lat_min || lat > xy_limits.lat_max)
      throw new BadRequestException(LATITUDE_OUT_OF_BORDER_MESSAGE);
    if (lon < xy_limits.lon_min || lon > xy_limits.lon_max)
      throw new BadRequestException(LONGITUDE_OUT_OF_BORDER_MESSAGE);
  }
}
